...
import com.xavier.config.JdbcDrivers;
...
public class DbManagementDialog extends JDialog {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DbManagementDialog.class);
    ...
    public DbManagementDialog(Configuration configuration) {
        ...
        historyList.addListSelectionListener(
                (ListSelectionEvent e) -> hisListChange()
        );
        ...
        driverComboBox.addItemListener(
                (ItemEvent e) -> driverComboBoxChange(e)
        );
        ...
        btnSave.addActionListener(
                (ActionEvent e) -> saveButtonClick()
        );
        bottomLeftPane.add(btnSave);

        JButton btnDelete = new JButton("删除");
        btnDelete.addActionListener(
                (ActionEvent e) -> deleteButtonClick()
        );
        ...
        btnCancel.addActionListener(
                (ActionEvent e) -> doClose(RET_CANCEL)
        );
        btnCancel.setActionCommand("Cancel");

        btnTest.addActionListener(
                (ActionEvent e) -> testButtonClick(true)
        );
